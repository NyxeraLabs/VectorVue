...
**New in v4.1:** Operational Cognition (Phase 5.5) - Attack graph pathfinding, objective distance, recommendation scoring, detection pressure tracking, OpSec simulation, event replay, operator tempo analysis, infrastructure burn tracking, confidence analysis, and pattern learning.
